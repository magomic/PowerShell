...
# <Module und PS-Zus�tze>{
# Diese Installation muss nur einmal ausfgef�hrt werden, sollte ctrl+v/c/x nicht funktionieren, dll in Modules\PSReadLine entfernen und folgende Installation erneut ausf�hren
# ToDo: pr�fen ob module geladen, wenn nein, dann laden evtl. Installation ausf�hren
...
#  a) wenn lokale dateien zu einem existierenden repository (online) �bertragen werden sollen
